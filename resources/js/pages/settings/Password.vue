            ...
            <div class="space-y-6">
                ...
                <form @submit.prevent="updatePassword" class="space-y-6">
                    ...
                    <div class="flex items-center gap-4">
                        <Button :disabled="form.processing">Actualizar contraseña</Button>
                        ...
                        >
                            <p v-show="form.recentlySuccessful" class="text-sm text-neutral-600">Actualizada.</p>
                        </Transition>
                    </div>
                </form>
            </div>
